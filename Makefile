...
PROJECT_REPO ?= github.com/playtika/$(PROJECT_NAME)
...
REGISTRY_ORGS ?= ghcr.io/playtikaoss
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= ghcr.io/playtikaoss
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= ghcr.io/playtikaoss
XPKGS = $(PROJECT_NAME)
