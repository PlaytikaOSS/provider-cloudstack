...
type NetworkOfferingInitParameters struct {
...
type NetworkOfferingObservation struct {
...
type NetworkOfferingParameters struct {
...
// NetworkOfferingSpec defines the desired state of NetworkOffering
type NetworkOfferingSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     NetworkOfferingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider NetworkOfferingInitParameters `json:"initProvider,omitempty"`
}

// NetworkOfferingStatus defines the observed state of NetworkOffering.
type NetworkOfferingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        NetworkOfferingObservation `json:"atProvider,omitempty"`
}
...
// NetworkOffering is the Schema for the NetworkOfferings API. Creates a Network Offering
...
type NetworkOffering struct {
	...
	Spec   NetworkOfferingSpec   `json:"spec"`
	Status NetworkOfferingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// NetworkOfferingList contains a list of NetworkOfferings
type NetworkOfferingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []NetworkOffering `json:"items"`
}

// Repository type metadata.
var (
	NetworkOffering_Kind             = "NetworkOffering"
	NetworkOffering_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: NetworkOffering_Kind}.String()
	NetworkOffering_KindAPIVersion   = NetworkOffering_Kind + "." + CRDGroupVersion.String()
	NetworkOffering_GroupVersionKind = CRDGroupVersion.WithKind(NetworkOffering_Kind)
)

func init() {
	SchemeBuilder.Register(&NetworkOffering{}, &NetworkOfferingList{})
}
