...
type UserInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/playtika/provider-cloudstack/apis/cloudstack/v1alpha1.Account
	Account *string `json:"account,omitempty" tf:"account,omitempty"`

	// Reference to a Account in cloudstack to populate account.
	// +kubebuilder:validation:Optional
	AccountRef *v1.Reference `json:"accountRef,omitempty" tf:"-"`

	// Selector for a Account in cloudstack to populate account.
	// +kubebuilder:validation:Optional
	AccountSelector *v1.Selector `json:"accountSelector,omitempty" tf:"-"`
