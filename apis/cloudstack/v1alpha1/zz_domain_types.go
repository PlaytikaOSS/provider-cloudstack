...
type DomainInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/playtika/provider-cloudstack/apis/cloudstack/v1alpha1.Domain
	ParentDomainID *string `json:"parentDomainId,omitempty" tf:"parent_domain_id,omitempty"`

	// Reference to a Domain in cloudstack to populate parentDomainId.
	// +kubebuilder:validation:Optional
	ParentDomainIDRef *v1.Reference `json:"parentDomainIdRef,omitempty" tf:"-"`

	// Selector for a Domain in cloudstack to populate parentDomainId.
	// +kubebuilder:validation:Optional
	ParentDomainIDSelector *v1.Selector `json:"parentDomainIdSelector,omitempty" tf:"-"`
}
