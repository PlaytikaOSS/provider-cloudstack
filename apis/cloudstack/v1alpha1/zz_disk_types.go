...
type DiskInitParameters struct {
	...
	// Reference to a DiskOffering in cloudstack to populate diskOffering.
	// +kubebuilder:validation:Optional
	DiskOfferingRef *v1.Reference `json:"diskOfferingRef,omitempty" tf:"-"`

	// Selector for a DiskOffering in cloudstack to populate diskOffering.
	// +kubebuilder:validation:Optional
	DiskOfferingSelector *v1.Selector `json:"diskOfferingSelector,omitempty" tf:"-"`
