...
type SecurityGroupRuleInitParameters struct {
	...
	Rule []SecurityGroupRuleRuleInitParameters `json:"rule,omitempty" tf:"rule,omitempty"`

	// The security group ID for which to create
	// the rules. Changing this forces a new resource to be created.
	// +crossplane:generate:reference:type=github.com/playtika/provider-cloudstack/apis/cloudstack/v1alpha1.SecurityGroup
	SecurityGroupID *string `json:"securityGroupId,omitempty" tf:"security_group_id,omitempty"`

	// Reference to a SecurityGroup in cloudstack to populate securityGroupId.
	// +kubebuilder:validation:Optional
	SecurityGroupIDRef *v1.Reference `json:"securityGroupIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in cloudstack to populate securityGroupId.
	// +kubebuilder:validation:Optional
...
type SecurityGroupRuleObservation struct {
	...
	// Can be specified multiple times. Each rule block supports
	// fields documented below.
	Rule []SecurityGroupRuleRuleObservation `json:"rule,omitempty" tf:"rule,omitempty"`
...
type SecurityGroupRuleParameters struct {
	...
	// fields documented below.
	// +kubebuilder:validation:Optional
	Rule []SecurityGroupRuleRuleParameters `json:"rule,omitempty" tf:"rule,omitempty"`
...
type SecurityGroupRuleRuleInitParameters struct {
...
type SecurityGroupRuleRuleObservation struct {
...
type SecurityGroupRuleRuleParameters struct {
...
// SecurityGroupRule is the Schema for the SecurityGroupRules API. Authorizes and revokes both ingress and egress rulea for a given security group.
